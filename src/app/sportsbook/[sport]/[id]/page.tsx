          ...
          <div className="flex items-stretch justify-center h-[72px] mx-[-8px]">
            {sportsList.map((sport) => (
              <button
                key={sport.id}
                onClick={() => {
                   if (sport.id === 'Cricket') router.push('/sportsbook')
                   else router.push('/sportsbook/' + sport.id)
                }}
            ...
            <>
              {isLoading && games.length === 0 ? (
                <div className="py-20 flex flex-col items-center justify-center text-white/20 gap-3">
                  ...
                  <p className="text-[10px] font-black uppercase tracking-widest">Loading competition games...</p>
                </div>
