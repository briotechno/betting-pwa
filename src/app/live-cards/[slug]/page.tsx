...
const slugToSearchTerm: Record<string, string> = {
  ...
  '32cardcasino': '32 Card'
}

export default function DynamicLiveCardsPage() {
  ...
  useEffect(() => {
    // Handling special redirect as requested: "2 Card Teenpatti also redirect to teenpatti"
    if (slug === '2-card-teenpatti' || slug === '2cardteenpatti') {
      router.replace('/live-cards/teenpatti')
      return
    }
