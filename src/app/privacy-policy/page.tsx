...
const sections = [
  {
    ...
    title: '1.1. Privacy',
    content: [
      `fairplay is committed to protecting your personal information. This Privacy Policy lets you know what information we collect when you use our services, why we collect this information and how we use the collected information.`,
  ...
  {
    id: '1.2',
    title: '1.2. Information Collected',
    content: [
  ...
  {
    id: '1.5',
    title: '1.5. Certain Excluded Disclosures',
    content: [
  ...
  {
    id: '1.7',
    title: '1.7. Consent to Use of Electronic Service Providers',
    content: [
  ...
  {
    id: '1.8',
    title: '1.8. Consent to Security Review',
    content: [
  ...
  {
    id: '1.10',
    title: '1.10. Protection of Minors',
    content: [
  ...
  {
    id: '1.11',
    title: '1.11. International Transfers',
    content: [
  ...
  },
  {
    ...
    subsections: [
      {
        title: 'Information placed on your device',
        content: [
      ...
      {
        title: 'During the registration process',
        content: [
  ...
  {
    id: '1.13',
    title: '1.13. Third-Party Practices',
    content: [
  ...
  {
    id: '1.15',
    title: '1.15. Consent to Privacy Policy',
    content: [
  ...
  return (
    <div className="min-h-screen bg-[#121212]">
      ...
      <div className="flex items-center gap-3 px-4 py-3 bg-[#1a1a1a] border-b border-white/10 sticky top-0 z-10">
        ...
        <h1 className="text-white text-[15px] font-bold tracking-wide">Privacy Policy</h1>
      </div>
