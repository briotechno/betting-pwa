  ...
  return (
    <div className="flex min-h-screen bg-[#121212] lg:gap-4 lg:bg-transparent">
      ...
      {(isAuthenticated || user) && (
        <div className="hidden lg:block lg:w-[480px] lg:sticky lg:top-[134px] lg:max-h-[calc(100vh-150px)] lg:overflow-y-auto self-start shrink-0 lg:border-none lg:rounded-lg lg:overflow-hidden lg:border-l border-white/5 bg-[#111] z-30">
