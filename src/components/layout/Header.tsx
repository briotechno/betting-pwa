...
export default function Header() {
  ...
  return (
    <div className="z-[60]">
      ...
      <div className={`fixed top-0 left-0 right-0 z-[60] bg-black backdrop-blur-md h-16 lg:h-[76px] transition-all duration-300`}>
      ...
      {isAuthenticated && (
        <div className="fixed top-[64px] lg:top-[76px] left-0 right-0 z-[59]">
          <NewsTicker />
        </div>
      )}
      ...
      <div className={`hidden lg:flex fixed ${isAuthenticated ? 'top-[110px]' : 'top-[76px]'} left-0 right-0 z-[58] items-center justify-center h-[52px] overflow-x-auto no-scrollbar bg-[#000] px-4 transition-all duration-300`}>
