...
export default function MainLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className={`transition-all duration-300 ${sidebarCollapsed ? 'lg:pl-[65px]' : 'lg:pl-[200px]'}`}>
      ...
      >
        <div className="w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_4px_15px_rgba(37,211,102,0.4)] border-2 border-white/20 transition-transform hover:scale-110">
